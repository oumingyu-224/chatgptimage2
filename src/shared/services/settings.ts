...
export async function getSettingTabs(tab: string) {
  ...
  const tabs: Tab[] = [
    ...
    {
      name: 'safety',
      title: t('edit.tabs.safety'),
      url: '/admin/settings/safety',
      is_active: tab === 'safety',
    },
    {
      name: 'analytics',
...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      ...
      title: t('groups.prompt_moderation'),
      description: 'Configure prompt moderation before image generation',
      tab: 'safety',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      placeholder:
        'Flux Klein is a NextJS boilerplate for building AI SaaS startups. ',
      type: 'textarea',
      group: 'appinfo',
      tab: 'general',
    },
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'Flux Klein Two <no-reply@mail.shipany.site>',
      group: 'resend',
      tab: 'email',
    },
    {
    ...
    {
      name: 'prompt_moderation_enabled',
      title: 'Enabled',
      type: 'switch',
      value: 'false',
      group: 'prompt_moderation',
      tab: 'safety',
      tip: 'Review image generation prompts before creating tasks',
    },
    {
      name: 'prompt_moderation_provider',
      title: 'Provider',
      type: 'select',
      value: 'deepseek',
    ...
    {
      name: 'prompt_moderation_deepseek_api_key',
    ...
    {
      name: 'prompt_moderation_deepseek_base_url',
    ...
    {
      name: 'prompt_moderation_deepseek_model',
